...
import { LogIn, Mail, Lock, CheckSquare, Loader2 } from "lucide-react";
      ...
      >
        <Card className="border shadow-lg transition-all duration-300">
          <CardHeader className="space-y-1 text-center">
            ...
            >
              <div className="h-16 w-16 rounded-xl bg-primary flex items-center justify-center shadow-lg shadow-primary/20">
            ...
            >
              ...
              >
                <Button
                  type="submit"
                  disabled={loading}
                  className="w-full transition-all hover:scale-105 active:scale-95 shadow-lg hover:shadow-xl hover:shadow-primary/50"
                  suppressHydrationWarning
                >
                  {loading ? (
                    <motion.div
