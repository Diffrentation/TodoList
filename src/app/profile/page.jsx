...
export default function ProfilePage() {
  ...
  return <ProtectedRoute><main className="min-h-screen bg-white px-4 py-7 text-slate-950 dark:bg-slate-950 dark:text-slate-100 sm:px-8 sm:py-10"><div className="mx-auto w-full max-w-3xl">
    ...
    <div className="mb-5 flex justify-end"><button type="button" onClick={() => router.push("/profile/security")} className="rounded-lg border border-slate-200 px-3 py-2 text-sm font-medium text-slate-600 hover:bg-slate-50 dark:border-slate-700 dark:text-slate-300 dark:hover:bg-slate-900">Security & sessions</button></div>
